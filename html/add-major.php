...
if(isset($_SESSION['user_name'])) {
   ...
   try{
    ...
    $result3 = $conn->executeQuery('QLSV.Chuyennganh', $query);
    $count = iterator_count($result3);
    $count++;
    $countString = "CN".$count;
                  ...
                  <ul>
                      ...
                      <li class="submenu active" >
                          ...
                          <ul>
                              ...
                              <li><a href="add-major.php" class="active">Major Add</a></li>
                          </ul>
                      </li>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        ...
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="major.php">Major</a></li>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="add-major-action.php" method="post">
                              <div class="row">
                                 <div class="col-12">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>Major ID</label><br>
                                       <?php

echo('<label>' .$countString. '</label>');
?>
                                        <input type="hidden" class="form-control" name="id" value="<?= $countString ?>" >
                                    </div>
                                 </div>
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
