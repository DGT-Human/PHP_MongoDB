...
if(isset($_SESSION['user_name'])) {
   ...
   try{
    ...
    $count++;
    $countString = "L0".$count;
    $result1 = $conn->executeQuery('QLSV.Giangvien', $query);
?>
<html lang="en">
...
<ul>
    ...
    <li class="submenu active ">
        ...
        <ul>
            ...
            <li><a href="add-class.php" class="active">Class Add</a></li>
        </ul>
    </li>
    <li class="submenu">
...
<div class="card">
<div class="card-body">
<form action="add-class-action.php" method="post">
<div class="row">
<div class="col-12">
...
?>
    <input type="hidden" class="form-control" name="classID" value="<?= $countString ?>" >
</div>
</div>
<div class="col-12 col-sm-6">
<div class="form-group">
...
echo '<option value="' . $rs1->ma_giang_vien . '">' . $rs1->ten . '</option>';
}
 ?>
</select>
</div>
