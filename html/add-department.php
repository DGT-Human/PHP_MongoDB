...
<ul>
    ...
    <li class="submenu active">
        ...
        <ul>
            ...
            <li><a href="add-department.php" class="active">Department Add</a></li>
        </ul>
    </li>
    <li class="submenu ">
...
<div class="card">
<div class="card-body">
<form action="add-department-action.php" method="post">
<div class="row">
<div class="col-12">
...
?>
    <input type="hidden" class="form-control" name="ma_khoa" value="<?= $countString ?>" >
