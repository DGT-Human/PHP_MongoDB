...
if(isset($_REQUEST['ma_chuyen_nganh']));
{
    $productID = $_REQUEST['ma_chuyen_nganh'];
    ...
    $query = new MongoDB\Driver\Query(['ma_chuyen_nganh'=>$productID], []);
   ...
   <body>
              ...
              <div class="content container-fluid">
                  ...
                  <div class="page-header">
                      <div class="row align-items-center">
                          <div class="col">
                              <h3 class="page-title">Edit Majors</h3>
                              <ul class="breadcrumb">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="update-major-action.php" method="post">
                              <div class="row">
                                 <div class="col-12">
                                 ...
                                 <?php
                                  foreach ($result as $rs) {
                                    $maKhoa = $rs->{'ma_khoa'};
                                    $queryKhoa = new MongoDB\Driver\Query(['ma_khoa' => $maKhoa]);
    ...
    // Lấy bản ghi đầu tiên từ kết quả (nếu có)
                                 ...
                                 echo '<div class="col-12 col-sm-6">';
                                    ...
                                    echo '<label>Major ID</label><br>';
                                    echo '<label>' . $rs->{'ma_chuyen_nganh'} . '</label>';
                                    echo '<input type="hidden" class="form-control" name="id" value="'. $rs->{'ma_chuyen_nganh'} .'" >';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '<div class="col-12 col-sm-6">';
                                    echo '<div class="form-group">';
                                    echo '<label>Major Name</label>';
                                    echo '<input name="name" type="text" class="form-control" value="' . $rs->{'ten_chuyen_nganh'} . '">';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '<div class="col-12 col-sm-6">';
                                    echo '<div class="form-group">';
...
// echo '<option value="' . $rs3->ma_khoa . '">' . $rs3->ten_khoa. '</option>';
// }
