   ...
   <body>
                                 ...
                                 <tbody
                                       ...
                                       $result2 = $conn->executeQuery('QLSV.Nhomhocphan', $query1);
                                        foreach ($result2 as $rs2) {
                                            ...
                                            echo '<td>' . $rs->{'hoc_ky'} . '</td >';
                                       echo '<td class="text-right" >',
                                          '<div class="actions" >',
                                             '<a href = "Edit-student-subject.php?id_DK='.$rs->{'id_DK'} .'" class="btn btn-sm bg-success-light mr-2" >',
                                             '<i class="fas fa-pen" ></i >',
                                             '</a >',
                                           '<a href="delete-student-subject.php?id_DK=' . $rs->{'id_DK'} . '&ma_sinh_vien='.$rs ->{'ma_sinh_vien'}.'" class="btn btn-sm bg-danger-light" onclick="return confirm(\'Are you sure you want to delete this subject?\')">',
      ...
      <script>
          ...
          function exportToXLSX() {
              ...
              XLSX.utils.book_append_sheet(wb, ws, "Subjects_sign");

              // Lưu workbook thành file XLSX
              XLSX.writeFile(wb, "subjects_sign.xlsx");
          }
      </script>
   </body>
   <!-- Mirrored from preschool.dreamguystech.com/html-template/subjects.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Oct 2021 11:11:50 GMT -->
