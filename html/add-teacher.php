...
if(isset($_SESSION['user_name'])) {
   ...
   try{
    ...
    $result3 = $conn->executeQuery('QLSV.Giangvien', $query);
    $count = iterator_count($result3);
    $count++;
    $countString = "GV".$count;
...
<div class="card">
<div class="card-body">
<form action="add-teacher-action.php" method="post">
<div class="row">
<div class="col-12">
...
?>
                                        <input type="hidden" class="form-control" name="teacher_id" value="<?= $countString ?>" >
                                    </div>
                                 </div>        
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>Status</label>
                                       <input type="text" class="form-control" name="status" value="Đang dạy">
                                    </div>
                                 </div>
                                 <div class="col-12">
