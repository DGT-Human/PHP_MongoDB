...
$result = $conn->executeQuery('QLSV.Hocphan', $query);
$result1 = $conn->executeQuery('QLSV.Hocphan', $query);
    $index = 1;
  ...
  if (isset($_GET['success1']) && $_GET['success1'] == true) {
   echo '<script>alert("Chỉnh sửa học phần thành công!");</script>';
}
?>
<html lang="en">
                  ...
                  <ul>
                      ...
                      <li class="submenu active">
                          ...
                          <ul>
                              ...
                              <?php
                              echo '<li><a href="add-subject.php?ma_hoc_phan=HP'.$index.'">Subject Add</a></li>';
                              ?>
               ...
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                      ...
                      echo '<a class="btn btn-primary" href="add-subject.php?ma_hoc_phan=HP'.$index.'">';
                              ...
                              <table class="table table-hover table-center mb-0 datatable">
                                 ...
                                 <tbody>
                                        ...
                                        foreach ($result as $rs) {
                                            ...
                                            echo '<td>';
                                          echo '<h2 >';
                                             echo '<a>'. $rs->{'ten_hoc_phan'}. '</a>';
                                          echo '</h2>';
                                       echo '</td>';
                                       echo '<td>'. $rs->{'so_tin_chi'}. '</td >';
                                       echo '<td class="text-right" >',
                                          '<div class="actions" >',
                                             '<a href = "edit-subject.php?ma_hoc_phan='.$rs->{'ma_hoc_phan'}.'" class="btn btn-sm bg-success-light mr-2" >',
                                             '<i class="fas fa-pen" ></i >',
                                             '</a >';
                                             echo '<a class="btn btn-sm bg-danger-light"  href="subjects_group_ID.php?ma_hoc_phan='.$rs->{'ma_hoc_phan'}.'">',
