...
<div class="col">
<h3 class="page-title">Add Subject_Group</h3>
<ul class="breadcrumb">
...
<div class="card">
<div class="card-body">
<form action="add-subject_Group-action.php" method="post">
<div class="row">
<div class="col-12">
...
<label>Subject ID</label>
    <?php
        echo '<input type="text" class="form-control" name="ID" value="'.$ma_nhom_hoc_phan.'">';
    ?>
</div>
</div>
<div class="col-12 col-sm-6">
...
<input type="text" class="form-control" name="name">
    ...
    <?php
        ...
        echo '<option value="' . $rs1->ma_hoc_phan . '">'.$rs1 -> {'ten_hoc_phan'}.'</option>';
        }
        echo '</select>';
        echo '</div>';
        echo '</div>';
    ...
    <div class="col-12 col-sm-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="DOW">
        </div>
    </div>
    <div class="col-12 col-sm-6">
        <div class="form-group">
