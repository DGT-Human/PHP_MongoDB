...
if(isset($_REQUEST['ma_khoa']));
{
    $productID = $_REQUEST['ma_khoa'];
    ...
    $query = new MongoDB\Driver\Query(['ma_khoa'=>$productID], []);
...
<div class="card">
<div class="card-body">
<form action="update-department-action.php" method="post">
<div class="row">
<div class="col-12">
...
<input type="text" name="name" class="form-control" value="'.$rs->{'ten_khoa'}.'">
</div>
</div>';
 echo '<div class="col-12 col-sm-6">',
                                      '<div class="form-group">',
                                      '<label>Head of Department</label>';
                                      echo '<select class="form-control" name="gv">';
                                      foreach ($result1 as $rs1) {
                                       echo '<option value="' . $rs1->{'ma_giang_vien'} . '" ' . (($rs->{'ma_giang_vien'} == $rs1->{'ma_giang_vien'}) ? 'selected' : '') . '>'.$rs1->{'ten'}.'</option>';
                                       }
                                       echo '</select>';
                                      echo '</div>',
                                      '</div>';
...
<div class="form-group">
<label>Office</label>
<input type="text" name="phong" class="form-control" value="'.$rs->{'phong'}.'">
</div>
</div>
<div class="col-12">
<input type="hidden" name="id" class="form-control" value="'.$objectIdString.'">
