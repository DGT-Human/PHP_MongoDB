...
$result = $conn->executeQuery('QLSV.Dangky', $query1);
$result1 = $conn->executeQuery('QLSV.Dangky', $query);
$index = 1;
   ...
   <body>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        <h3 class="page-title">Subjects of student</h3>
                        <ul class="breadcrumb">
                      ...
                      echo '<a class="btn btn-primary" href="add-student-subject.php?id_DK=DK'.$index.'&ma_sinh_vien='.$ma_sinh_vien.'">';
                              ...
                              <table class="table table-hover table-center mb-0 datatable">
                                 ...
                                 <tbody
                                       ...
                                       echo '<td class="text-right" >',
                                          '<div class="actions" >',
                                           '<a href = "Edit-student-subject.php?id_DK='.$rs->{'id_DK'} . '" class="btn btn-sm bg-success-light mr-2">',
                                             '<i class="fas fa-pen" ></i >',
                                             '</a >',
                                            '<a href="delete-student-subject.php?id_DK=' . $rs->{'id_DK'} . '&ma_sinh_vien='.$rs->{'ma_sinh_vien'}.'" class="btn btn-sm bg-danger-light mr-2" onclick="return confirm(\'Are you sure you want to delete this subject?\')">',
                                            '<i class="fas fa-trash"></i>',
                                             '</a >',
                                           '<a href="add-score1.php?ma_sinh_vien=' . $rs->{'ma_sinh_vien'} . '&ma_nhom_hoc_phan='.$rs->{'ma_nhom_hoc_phan'}.'" class="btn btn-sm bg-danger-light mr-2">',
      ...
      <script>
          ...
          function exportToXLSX() {
              ...
              XLSX.utils.book_append_sheet(wb, ws, "students-subject_ID");

              // Lưu workbook thành file XLSX
              XLSX.writeFile(wb, "students-subject_ID.xlsx");
          }
